...
module.exports = {
	...
	getHotelById2: function(id, callback){
		var sql = "select * from hotels where hotelAddress='"+id+"' ";
		db.getResult(sql, function(result){
			callback(result);
		});
	},
	...
	register: function(user, callback){
		var sql = "insert into user values ('', '"+user.username+"', '"+user.address+"', '"+user.email+"','"+user.phone+"','"+user.password+"','client')";
